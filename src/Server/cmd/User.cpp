...
/*   Updated: 2023/04/18 16:02:51 by jlarrieu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Server::HandleUser(Client *client, std::istringstream &iss)
{
    ...
    // else
    // {
    //     std::cout << "Client not authenticated oui: " << inet_ntoa(client->GetAddress().sin_addr) << " sock: " << client->GetSocketDescriptor() << std::endl;
